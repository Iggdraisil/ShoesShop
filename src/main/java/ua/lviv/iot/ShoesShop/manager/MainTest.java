...
import ua.lviv.iot.ShoesShop.shoes.Shoes;
import ua.lviv.iot.ShoesShop.shoes.ChildsAge;
import ua.lviv.iot.ShoesShop.shoes.Role;
import ua.lviv.iot.ShoesShop.shoes.Material;
import ua.lviv.iot.ShoesShop.shoes.Seasons;
import ua.lviv.iot.ShoesShop.shoes.ChildsShoes;
import ua.lviv.iot.ShoesShop.shoes.SportShoes;
...
public class MainTest {
    ...
    public static void main(final String[] args) {
        ...
        list.add(new Shoes(42, "Blue", Material.LEATHER,
                5000, Seasons.SUMMER, Role.MEN, "LaCosta"));
        list.add(new Shoes(46, "Black", Material.SHMIT, 500,
        ...
        shoesShopManager.printListOfShoes(
                shoesShopManager.sortBySize(SortType.DESCENDING));
        shoesShopManager.printListOfShoes(
                shoesShopManager.sortByPrice(SortType.ASCENDING));
        shoesShopManager.printListOfShoes(
                shoesShopManager.filterBySize(42));
        shoesShopManager.printListOfShoes(
                shoesShopManager.filterByRole(Role.SPORT));
    }
}
